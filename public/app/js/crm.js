...
function _leadsHtml() {
    ...
    return '<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px;flex-wrap:wrap;gap:8px">'+
        ...
        '<div class="card" style="overflow:hidden"><div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;min-width:760px">'+
...
function _tasksHtml(){
    ...
    return filters+'<div class="card" style="overflow:hidden"><div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;min-width:640px"><thead><tr style="border-bottom:1px solid var(--bd)"><th style="padding:10px 14px;width:10px"></th>'+_th('Task')+_th('Lead')+_th('Priority')+_th('Due')+'<th style="padding:10px 14px;text-align:center;font-size:11px;font-weight:600;color:var(--t3);text-transform:uppercase">Actions</th></tr></thead><tbody id="tasks-tbody">'+rows+'</tbody></table></div></div>';
}
...
function _apptHtml(){
    ...
    return '<div class="card" style="overflow:hidden"><div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;min-width:700px"><thead><tr style="border-bottom:1px solid var(--bd)">'+_th('Title')+_th('Lead')+_th('Start')+_th('End')+_th('Status')+'<th style="padding:10px 14px;text-align:center;font-size:11px;font-weight:600;color:var(--t3);text-transform:uppercase">Actions</th></tr></thead><tbody>'+(rows||empty)+'</tbody></table></div></div>';
}
