...
class AdminPageController
{
    ...
    {
        // PLATFORM SECURITY 1.0 (2026-08-03) — the registry, filtered by who is
        // asking. Every downstream use in this method reads $pages: the slug
        // lookup, the 404, the sidebar and window.ADMIN_PAGES. Filtering once
        // here therefore filters all of them, which is the point — a module
        // hidden in one place and present in another is not hidden.
        //
        // An entry with no 'capability' key is returned for any platform admin,
        // so all 54 pre-existing pages behave exactly as they did before.
        $pages = AdminRegistry::make()->visibleFor($request);
