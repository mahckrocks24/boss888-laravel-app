...
class AgentSeeder extends Seeder
{
    public function run(): void
    {
        $agents = [
            ...
            ['name'=>'Zoe','slug'=>'zoe','title'=>'TikTok & Reels Creator','description'=>'Short-form video strategy, trending formats, and viral hooks.','category'=>'social','level'=>'junior','orb_type'=>'ads','color'=>'#EC4899','is_dmm'=>false,'capabilities_json'=>['tiktok_strategy','trending_formats','viral_hooks'],'skills_json'=>['TikTok Strategy','Trending Formats','Viral Hooks']],
