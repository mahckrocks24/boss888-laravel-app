    ...
    Route::prefix('seo')->group(function () {
        ...
        Route::get('/sitemap', function (\Illuminate\Http\Request $r) {
            ...
            if (in_array($host, $platformHosts, true)) {
                return response()->json([
                    ...
                    'message'     => 'This is the LevelUpGrowth platform admin URL, not a content site. Sitemaps are auto-generated for your tenant sites — switch to one in the site dropdown above.',
                ]);
            }
        ...
        $auditReportBuildHtml = function (int $wsId, string $host): string {
            ...
            $html = '<!doctype html><html><head><meta charset="utf-8">'
                ...
                . '<div class="foot">Generated by LevelUpGrowth · ' . $esc($generatedAt) . '</div>'
                . '</body></html>';
