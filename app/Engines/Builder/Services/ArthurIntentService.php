...
class ArthurIntentService
{
    ...
    public function interpret(int $wsId, int $websiteId, object $site, string $request, array $ctx, array $siteCtx): ?array
    {
        ...
        $system = "You are Arthur, the website assistant of {$siteCtx['name']}, a {$siteCtx['industry']} business whose website was built with LevelUpGrowth. "
            ...
            . "OUTPUT (JSON only)\n"
            . '{"intent":"copy_edit|style|catalogue|section_add|section_remove|page_add|image|video|overlay|image_edit|logo|tracking|answer|clarify|unsupported","confidence":0.0-1.0,"normalized":"the request as one explicit self-contained sentence","reply":"one or two sentences to the customer (answer/unsupported)","question":"the clarifying question","options":["…"],"copy":[{"key":"…","value":"…"}],"tracking":{"ga4":"","gtm":"","meta_pixel":"","tiktok_pixel":""},"catalogue":{"kind":"…","action":"add|price|status|rename|remove|toggle","item":"…","title":"…","price":0,"currency":"USD","period":"","status":"…","note":"","summary":"","attrs":{}}}';
