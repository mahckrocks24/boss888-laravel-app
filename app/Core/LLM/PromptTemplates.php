...
- "engine": which engine to use (crm, seo, write, creative, builder, calendar, beforeafter, traffic, social). NOTE: the email-marketing engine is NOT available in this product — never output "marketing"; if the user asks for email campaigns/newsletters, set requires_agent=false, confidence low, and clarification_needed explaining it is not supported. Social posting IS available (engine "social", agent marcus).
...
- "agent_id": suggested agent slug if requires_agent is true (sarah, james, priya, elena, alex, nora, max, sofia, marcus — never an email specialist)
