...
class ToolSchemaService
{
    ...
    public function getToolSchemaPrompt(string $agentSlug, ?array $domains = null, string $turn = ''): string
    {
        ...
        $lines[] = '- Comment replies, engagement, inbox, social listening, competitor monitoring, email marketing, campaigns, newsletters and sequences are NOT part of the LevelUp Growth product. They are not missing, not disconnected, not unconfigured, and not gated behind a plan.';
