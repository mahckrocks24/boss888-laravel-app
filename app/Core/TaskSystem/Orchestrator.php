...
class Orchestrator
{
    ...
    private static function friendlyMessageFor(string $key, array $raw = [], bool $noChange = false): string
    {
        ...
        static $map = [
            ...
            'seo/generate_meta'            => 'Meta title and description generated.',
            'crm/update_lead'              => 'Lead updated in the CRM.',
            'crm/log_activity'             => 'Activity logged on the lead.',
            'crm/create_lead'              => 'Lead added to the CRM.',
            'creative/generate_design'     => 'Design draft created.',
            'write/create_article'         => 'Article draft created.',
            'write/fill_missing_images'    => 'Missing images generated.',
